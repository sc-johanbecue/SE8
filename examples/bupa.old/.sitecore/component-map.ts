...
import * as BupaHeader from 'components/bupa/BupaHeader';
import * as BupaHero from 'components/bupa/BupaHero';
import * as BupaPromiseCards from 'components/bupa/BupaPromiseCards';
import * as BupaWhyChooseUs from 'components/bupa/BupaWhyChooseUs';
import * as BupaPlanFinder from 'components/bupa/BupaPlanFinder';
import * as BupaFooter from 'components/bupa/BupaFooter';
import * as BupaCarousel from 'components/bupa/BupaCarousel';
import * as BupaRegionSelector from 'components/bupa/BupaRegionSelector';
...
export const componentMap = new Map<string, NextjsContentSdkComponent>([
  ...
  ['BupaHeader', BupaHeader],
  ['BupaHero', BupaHero],
  ['BupaCarousel', BupaCarousel],
  ['BupaPromiseCards', BupaPromiseCards],
  ['BupaWhyChooseUs', BupaWhyChooseUs],
  ['BupaPlanFinder', BupaPlanFinder],
  ['BupaFooter', BupaFooter],
  ['BupaRegionSelector', BupaRegionSelector],
]);
