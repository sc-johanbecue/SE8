                            ...
                            <div className="c-culture-switch__container container component-fullwidth--padded-lg">
                              <article className="c-culture-switch__column">
                                ...
                                <section className="c-culture-switch__area">
                                  ...
                                  <ul className="c-culture-switch__list js-lang-list c-culture-switch__list--two-cols">
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-cy.languageswitch.html">
                                        Cyprus
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/fr-fr.languageswitch.html">
                                        France
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-gr.languageswitch.html">
                                        Greece
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/it-it.languageswitch.html">
                                        Italy
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/en-lv.languageswitch.html">
                                        Latvia
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-no.languageswitch.html">
                                        Norway
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/en-pl.languageswitch.html">
                                        Poland
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-ru.languageswitch.html">
                                        Russia
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/en-rs.languageswitch.html">
                                        Serbia
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/es-es.languageswitch.html">
                                        Spain
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/en-se.languageswitch.html">
                                        Sweden
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-tr.languageswitch.html">
                                        Turkey
                                      </Link>
                                    </li>
                                    <li>
                              ...
                              <article className="c-culture-switch__column">
                                <section className="c-culture-switch__area">
                                  ...
                                  <ul className="c-culture-switch__list js-lang-list">
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/es-mx.languageswitch.html">
                                        Mexico
                                      </Link>
                                    </li>
                                    <li>
                                ...
                                <section className="c-culture-switch__area">
                                  ...
                                  <ul className="c-culture-switch__list js-lang-list c-culture-switch__list--two-cols">
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-jo.languageswitch.html">
                                        Jordan
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/en-kw.languageswitch.html">
                                        Kuwait
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-qa.languageswitch.html">
                                        Qatar
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-iq.languageswitch.html">
                                        Iraq
                                      </Link>
                                    </li>
                                  </ul>
                              ...
                              <article className="c-culture-switch__column">
                                <section className="c-culture-switch__area">
                                  ...
                                  <ul className="c-culture-switch__list js-lang-list c-culture-switch__list--two-cols">
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/pt-br.languageswitch.html">
                                        Brazil
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/es-cl.languageswitch.html">
                                        Chile
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/es-pa.languageswitch.html">
                                        Panama
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/es-pe.languageswitch.html">
                                        Peru
                                      </Link>
                                    </li>
                                    <li>
                                ...
                                <section className="c-culture-switch__area">
                                  ...
                                  <ul className="c-culture-switch__list js-lang-list c-culture-switch__list--two-cols">
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/zh-cn.languageswitch.html">
                                        China
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-in.languageswitch.html">
                                        India
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/ja-jp.languageswitch.html">
                                        Japan
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/en-np.languageswitch.html">
                                        Nepal
                                      </Link>
                                    </li>
                                    <li>
                              ...
                              <article className="c-culture-switch__column">
                                ...
                                <section className="c-culture-switch__area">
                                  ...
                                  <ul className="c-culture-switch__list js-lang-list c-culture-switch__list--two-cols">
                                    <li>
                                      <Link href="https://www.ktm.com/fr-bj.languageswitch.html">
                                        Benin
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/en-eg.languageswitch.html">
                                        Egypt
                                      </Link>
                                    </li>
                                    <li>
                                      <Link href="https://www.ktm.com/en-ke.languageswitch.html">
                                        Kenya
                                      </Link>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                      <Link href="https://www.ktm.com/fr-tg.languageswitch.html">
                                        Togo
                                      </Link>
                                    </li>
                                  </ul>
                            ...
                            >
                              <div className="c-image__content">
                                ...
                                >
                                  <div className="s7responsiveContainer">
                                    <Image
                                      src="https://s7g10.scene7.com/is/image/ktm/KTM-dual-sport-690-enduror-segment-page-action-image:Small?wid=801&hei=801&dpr=off"
                                      alt="Rider drives an KTM Electric Bike along a rugged, rocky trail surrounded by natural terrain."
                                      className="fluidimage"
                                      sizes="100vw"
                                      width={0}
                                      height={0}
                                      id="dynamicmedia_65130352_resp"
                                      data-src="https://s7g10.scene7.com/is/image/ktm/KTM-dual-sport-690-enduror-segment-page-action-image"
                                      data-mode="smartcrop"
                                      data-enablehd="always"
                                      data-aspectratio="true"
                                      style={{ width: '100%', height: 'auto' }}
                        ...
                        <div className="cq-dd-image">
                          ...
                          >
                            ...
                            >
                              <div className="c-image__content">
                                <div
                                  id="dynamicmedia_102935390"
                                  data-current-page="/content/websites/ktm-com/europe/be/en"
                                  data-page-locale="en_be"
                                  data-asset-path="ktm/KTM-supermoto-690-smcr-segment-action"
                                  data-asset-name="KTM-supermoto-690-smcr-segment-action.jpg"
                                  data-asset-type="image"
                                  data-viewer-path="https://s7g10.scene7.com/s7viewers/"
                                  data-imageserver="https://s7g10.scene7.com/is/image/"
                                  data-videoserver="https://s7g10.scene7.com/is/content/"
                                  ...
                                  data-aspectratio="true"
                                  data-linktarget="_self"
                                  data-alt="Motorcyclist in orange gear performs a wheelie on a KTM Enduro Bike over a rock in a hilly landscape under clear blue sky."
                                  className="s7dm-dynamic-media-ktm"
                                >
                                  <div className="s7responsiveContainer">
                                    <Image
                                      src="https://s7g10.scene7.com/is/image/ktm/KTM-supermoto-690-smcr-segment-action:Small?wid=801&hei=801&dpr=off"
                                      alt="Motorcyclist in orange gear performs a wheelie on a KTM Enduro Bike over a rock in a hilly landscape under clear blue sky."
                                      className="fluidimage"
                                      sizes="100vw"
                                      width={0}
                                      height={0}
                                      id="dynamicmedia_102935390_resp"
                                      data-src="https://s7g10.scene7.com/is/image/ktm/KTM-supermoto-690-smcr-segment-action"
                                      data-mode="smartcrop"
                                      data-enablehd="always"
                                      data-aspectratio="true"
                                      style={{ width: '100%', height: 'auto' }}
                        ...
                        <div className="cq-dd-image">
                          ...
                          >
                            ...
                            >
                              <div className="c-image__content">
                                <div
                                  id="dynamicmedia_70873038"
                                  data-current-page="/content/websites/ktm-com/europe/be/en"
                                  data-page-locale="en_be"
                                  data-asset-path="ktm/MY25-KTM-DUKE2-STAGE"
                                  data-asset-name="MY25-KTM-DUKE2-STAGE.png"
                                  data-asset-type="image"
                                  data-viewer-path="https://s7g10.scene7.com/s7viewers/"
                                  data-imageserver="https://s7g10.scene7.com/is/image/"
                                  data-videoserver="https://s7g10.scene7.com/is/content/"
                                  ...
                                  data-aspectratio="true"
                                  data-linktarget="_self"
                                  data-alt="Motorcyclist in orange gear performs a wheelie on a KTM naked bike on a racetrack."
                                  className="s7dm-dynamic-media-ktm"
                                >
                                  <div className="s7responsiveContainer">
                                    <Image
                                      src="https://s7g10.scene7.com/is/image/ktm/MY25-KTM-DUKE2-STAGE:Small?wid=801&hei=801&dpr=off"
                                      alt="Motorcyclist in orange gear performs a wheelie on a KTM naked bike on a racetrack."
                                      className="fluidimage"
                                      sizes="100vw"
                                      width={0}
                                      height={0}
                                      id="dynamicmedia_70873038_resp"
                                      data-src="https://s7g10.scene7.com/is/image/ktm/MY25-KTM-DUKE2-STAGE"
                                      data-mode="smartcrop"
                                      data-enablehd="always"
                                      data-aspectratio="true"
                                      style={{ width: '100%', height: 'auto' }}
                        ...
                        <div className="cq-dd-image">
                          ...
                          >
                            ...
                            >
                              <div className="c-image__content">
                                <div
                                  id="dynamicmedia_36269054"
                                  data-current-page="/content/websites/ktm-com/europe/be/en"
                                  data-page-locale="en_be"
                                  data-asset-path="ktm/643505_KTM-ADVENTURE-RALLY-TEASER-2025_Teaser-Images"
                                  data-asset-name="643505_KTM-ADVENTURE-RALLY-TEASER-2025_Teaser-Images.jpg"
                                  data-asset-type="image"
                                  data-viewer-path="https://s7g10.scene7.com/s7viewers/"
                                  data-imageserver="https://s7g10.scene7.com/is/image/"
                                  data-videoserver="https://s7g10.scene7.com/is/content/"
                                  ...
                                  data-aspectratio="true"
                                  data-linktarget="_self"
                                  data-alt="A rider on an KTM Adventure motorcycle travels down a dirt road, highlighting the excitement of off-road biking adventures."
                                  className="s7dm-dynamic-media-ktm"
                                >
                                  <div className="s7responsiveContainer">
                                    <Image
                                      src="https://s7g10.scene7.com/is/image/ktm/643505_KTM-ADVENTURE-RALLY-TEASER-2025_Teaser-Images:Small?wid=801&hei=801&dpr=off"
                                      alt="A rider on an KTM Adventure motorcycle travels down a dirt road, highlighting the excitement of off-road biking adventures."
                                      className="fluidimage"
                                      sizes="100vw"
                                      width={0}
                                      height={0}
                                      id="dynamicmedia_36269054_resp"
                                      data-src="https://s7g10.scene7.com/is/image/ktm/643505_KTM-ADVENTURE-RALLY-TEASER-2025_Teaser-Images"
                                      data-mode="smartcrop"
                                      data-enablehd="always"
                                      data-aspectratio="true"
                                      style={{ width: '100%', height: 'auto' }}
                        ...
                        <article className="c-teaser-list__item c-teaser-list__item--three-items-per-row">
                          ...
                          <div className="c-teaser-list__content c-teaser-list__content--three-items-per-row">
                            ...
                            <div className="c-teaser-list__teaser c-teaser-list__teaser--three-items-per-row line-clamp-4">
                              ...
                              Profiteer van raceklare deals op geselecteerde motocross-, enduro-,
                              travel-, sporttourer- en naked-modellen - er is nooit een beter moment
                              geweest om je slag te slaan.
                            </div>
                          </div>
                        </article>
                        <article className="c-teaser-list__item c-teaser-list__item--three-items-per-row">
                          ...
                          <div className="c-teaser-list__content c-teaser-list__content--three-items-per-row">
                            ...
                            >
                              <h2 className="c-teaser-list__title c-teaser-list__title--three-items-per-row line-clamp-3">
                                DANIEL SANDERS CROWNED 2025 WORLD RALLY-RAID CHAMPION WITH VICTORY
                                IN PORTUGAL
                              </h2>
                              <span className="c-teaser-list__cta c-teaser-list__cta--three-items-per-row">
                                View Profile
                            ...
                            <div className="c-teaser-list__teaser c-teaser-list__teaser--three-items-per-row line-clamp-4">
                              Red Bull KTM Factory Racing’s Daniel Sanders has secured the 2025 FIM
                              World Rally-Raid Championship with a dominant win at round four, Rally
                              Raid Portugal. Continuing his unbeaten record this season, ‘Chucky’
                              topped the timesheets in the prologue and three of the five stages to
                              take the race win and the championship crown in style. Luciano
                              Benavides rode his KTM 450 RALLY to third place overall, while Edgar
                              Canet took the win in the hotly contested Rally2 category.
                            </div>
                          </div>
                        </article>
                        <article className="c-teaser-list__item c-teaser-list__item--three-items-per-row">
                          ...
                          <div className="c-teaser-list__content c-teaser-list__content--three-items-per-row">
                            ...
                            <div className="c-teaser-list__teaser c-teaser-list__teaser--three-items-per-row line-clamp-4">
                              Red Bull KTM Factory Racing’s Josep Garcia has secured the 2025 FIM
                              Enduro1 World Championship with a commanding performance at the
                              EnduroGP of Italy. Despite a challenging Sunday in Darfo Boario Terme,
                              where Garcia battled through the pain from a late crash on Saturday,
                              he did what he had to do to take the title with one round to spare.
                            </div>
                          </div>
                        </article>
                      </div>
            ...
            <div className="footer aem-GridColumn aem-GridColumn--default--12">
              <footer>
                <div className="c-footer__additional-text">
                  <p>
                    The stated discount is exclusively available at participating, authorized KTM
                    dealers. All information is non-binding. Printing, layout, and typographical
                    errors as well as other mistakes are reserved. Information may be changed at any
                    time without prior notice.
                  </p>
                  <p>
                    The illustrated vehicles may vary in selected details from the production models
                    and some illustrations feature optional equipment available at additional cost.
                    All information concerning the scope of supply, appearance, services, dimensions
                    and weights is non-binding and specified with the proviso that errors, for
                    instance in printing, setting and/or typing, may occur; such information is
                    subject to change without notice. Please note that model specifications may vary
                    from country to country. In the case of coated surfaces, there may be color
                    differences due to the usual process fluctuations. The consumption values stated
                    refer to the roadworthy series condition of the vehicles at the time of factory
                    delivery.
                  </p>
                </div>
                    ...
                    <nav>
                      <div className="c-footer__col" data-opened="false">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link
                              href="https://www.ktm.com/en-be/ktm-world/brand-values.html"
                              target="_self"
                            >
                              BRAND VALUES
                            </Link>
                          ...
                          <li>
                            <Link
                              href="https://www.ktm.com/en-be/become-a-dealer.html"
                              target="_self"
                            >
                              BECOME A DEALER
                            </Link>
                      ...
                      <div className="c-footer__col" data-opened="false">
                        ...
                        <ul>
                          <li>
                            <Link
                              href="https://www.ktm.com/en-be/ktm-world/news.html"
                              target="_self"
                            >
                              NEWS
                            </Link>
                          ...
                          <li>
                            <Link
                              href="https://www.ktm.com/en-be/tech-guide/ktm-app.html"
                              target="_self"
                            >
                              KTM CONNECT APP
                            </Link>
                      ...
                      <div className="c-footer__col" data-opened="false">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link
                              href="https://www.ktm.com/en-be/service/Maintenance.html"
                              target="_self"
                            >
                              MAINTENANCE
                            </Link>
                      ...
                      <div className="c-footer__col" data-opened="false">
                        ...
                        <ul>
                          ...
                          <li>
                            <Link
                              href="https://www.ktm.com/en-be/legal-notices.html"
                              target="_self"
                            >
                              LEGAL NOTICES
                            </Link>
                          ...
                          <li>
                            <Link
                              href="https://www.ktm.com/en-be/privacy-policy.html"
                              target="_self"
                            >
                              PRIVACY POLICY
                            </Link>
            ...
            >
              <div className="ot-pc-header">
                <div className="ot-pc-logo" role="img" aria-label="Company Logo">
                  <Image
                    src="https://cdn.cookielaw.org/logos/197e1760-6f65-4a53-82fe-de3f0568609a/01904f47-2b2d-75a0-acb5-6494f79d92be/1e238fb7-5c81-45d6-934e-c9191d1bc801/ktm.jpg"
                    alt="Company Logo"
                    sizes="100vw"
                    width={0}
                    height={0}
                ...
                <button
                  ...
                  aria-label="Close"
                  style={{
                    backgroundImage: 'url(https://cdn.cookielaw.org/logos/static/ot_close.svg',
                  }}
                ></button>
              </div>
              <div id="ot-pc-content" className="ot-pc-scrollbar">
                ...
                <div id="ot-pc-desc">
                  ...
                  preferences or your device and is mostly used to make the site work as you expect
                  it to. The information does not usually directly identify you, but it can give you
                  a more personalized web experience. Because we respect your right to privacy, you
                  can choose not to allow some types of cookies. Click on the different category
                  headings to find out more and change our default settings. However, blocking some
                  types of cookies may impact your experience of the site and the services we are
                  able to offer.
                  <br />
                  <Link
                    href="https://www.ktm.com/en-int/privacy-policy.html"
                  ...
                  <Link
                    href="https://www.ktm.com/en-int/imprint.html"
                    className="ot-link-btn ot-imprint-handler"
                    target="_blank"
                    rel="noopener"
                ...
                <section className="ot-sdk-row ot-cat-grp">
                  ...
                  >
                    ...
                    <p className="ot-category-desc" id="ot-desc-id-C0001">
                  ...
                  <div className="ot-cat-item ot-vs-config" data-optanongroupid="C0002">
                    ...
                    <p className="ot-category-desc" id="ot-desc-id-C0002">
                  ...
                  <div className="ot-cat-item ot-vs-config" data-optanongroupid="C0004">
                    ...
                    <p className="ot-category-desc" id="ot-desc-id-C0004">
                  ...
                  <div className="ot-cat-item ot-vs-config" data-optanongroupid="C0005">
                    <h4 className="ot-cat-header" id="ot-header-id-C0005">
                    ...
                    <div className="ot-tgl">
                      ...
                      <label className="ot-switch" htmlFor="ot-group-id-C0005">
                        <span className="ot-label-txt">Social Media Cookies</span>
                      </label>
                    </div>
                    <p className="ot-category-desc" id="ot-desc-id-C0005">
                  ...
                  <div className="ot-cat-item ot-vs-config" data-optanongroupid="C0003">
                    ...
                    <p className="ot-category-desc" id="ot-desc-id-C0003">
              ...
              <div className="ot-pc-footer ot-pc-scrollbar">
                <div className="ot-btn-container">
                  <button className="ot-pc-refuse-all-handler">Reject All</button>{' '}
