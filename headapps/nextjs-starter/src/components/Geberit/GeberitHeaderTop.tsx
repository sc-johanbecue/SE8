...
export const Default = (props: HeaderTopProps): JSX.Element => {
  ...
  const phKeyMainNavigation = `GeberitMainNavigation-${props.params.DynamicPlaceholderId}`;

  return (
    <>
      <div id="mega-menu" className={`component sc-821ebc6d-0 fFGleh ${props.params.styles}`}>
        <div className="sc-821ebc6d-9 eMdFQK">
          <div id="page-header" className="sc-eb953e09-0 kbKFyA">
            <div className="sc-gFqAkR pBsox">
              <nav className="sc-eb953e09-1 kndgIn">
                ...
                <div className="sc-4a82434-0 OuYSi">
                  <button
                    className="sc-gEvEer fYeZsz"
                    type="button"
                  ...
                  >
                    ...
                    <span style={{ width: '1rem' }} className="sc-aXZVg dRbgvV icon ">
                      <svg viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8.00004 10.29L2.50004 4.79001L1.79004 5.50001L8.00004 11.71L14.21 5.50001L13.5 4.79001L8.00004 10.29Z"></path>
                      </svg>
                    </span>
                  </button>
                  <div
                ...
                <div className="sc-eb953e09-3 iqEvvd">
                  ...
                  {props.params.ShowUserLoginButton ? (
                  ...
                  {props.params.ShowCatalogueButton ? (
          ...
          <Placeholder name={phKeyMainNavigation} rendering={props.rendering} />
        </div>
      </div>
    </>
  );
