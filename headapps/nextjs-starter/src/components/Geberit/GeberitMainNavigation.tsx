...
const MainNavigationDefaultComponent = (props: MainNavigationProps): JSX.Element => (
  <div className={`component MainNavigation ${props.params.styles}`}>
    <div className="component-content">
      <span className="is-empty-hint">MainNavigation</span>
    </div>
  </div>
);
 ...
 * - No fields are needed at the MainNavigation level
 */
export const Default = (props: MainNavigationProps): JSX.Element => {
  ...
  return (
    <div
      className={`component sc-e5ce6e88-1 iXbDnK ${props.params.styles}`}
      key={id ? id : undefined}
      id={id ? id : undefined}
    >
      <div className="sc-587a74fb-0 hvXFzQ" style={{ display: 'inline' }}>
        <div className="sc-gFqAkR pBsox">
            ...
            <div className="sc-821ebc6d-6 eMqlDi">
              {items.map((item, index) => (
                <li className="sc-821ebc6d-1 hkLOLM" key={index}>
                  <JssLink
                    className="sc-5b3e516d-0 dJecPp gtm-utm-ignored-link"
          ...
          <ul className="sc-42f4379a-1 hRofbz first-level">
            {items.map((item, index) => (
              <li className="sc-821ebc6d-1 hkLOLM" key={index}>
                <JssLink
                  className="sc-955e2100-0 kJMsPW gtm-utm-ignored-link"
                  field={item.fields.Href}
                >
                  <Text field={item.fields.Text} />
                </JssLink>
        ...
        <div className="sc-eb953e09-11 jA-dEPF" style={{ display: 'none' }}>
          <div className="sc-eb953e09-12 llTAjB" key="SearchBox">
            <div className="sc-gFqAkR pBsox">
  ...
  return <MainNavigationDefaultComponent {...props} />;
};
