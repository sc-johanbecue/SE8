...
const DefaultContent = (props: SocialsContainerProps): JSX.Element => (
  <div
    className={`component SocialsContainer ${props.params.styles}`}
    id={props.params.RenderingIdentifier || undefined}
  >
    <div className="component-content">
      <span className="is-empty-hint">Socials Container Component</span>
    </div>
  </div>
);
...
export const Default = (props: SocialsContainerProps): JSX.Element => {
  ...
  if (props.fields) {
    return (
      <div className={`component SocialsContainer ${props.params.styles}`} id={id || undefined}>
        <div className="component-content">
          <a
